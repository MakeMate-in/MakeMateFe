...
import DashboardPageCustomer from '../components/Customer/CompanyDashboardCustomer/DashboardPageCustomer';
...
return(
    ...
    <Routes>
        ...
        <Route path={OPEN_ROUTES.PRODUCT} element={<DashboardPageCustomer/>}/>
