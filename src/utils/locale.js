export const NOTIFICATION_MESSAGES = {
    FETCH_SERVICES_ERROR : 'Unable t fetch Services',
    UPDATE_SERVICES_ERROR : 'Unable to update Services',
    UPDATE_SERVICES_SUCCESS: 'Services Updated Successfully',
    ...
    ERROR_FETCH_DETAILS: 'Failed to Fetch Details'
}